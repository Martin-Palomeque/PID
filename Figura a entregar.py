...
# ax.axvline(t_on[0],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[1],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[3],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[4],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[5],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[6],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[7],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[8],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[9],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
# ax.axvline(t_on[10],0,1,linestyle = ':',color = 'darkgreen',alpha = 0.2)
